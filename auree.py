...
class Login:
 ...
 {self.color.light_blue}CP > {self.cp}{self.color.reset}
  ...
  def b_graph(self,user_id,passwords):
    try:
      print(f" ({self.color.light_blue}AVAH {self.ip}•{self.color.reset} {self.color.light_blue}{self.loop}{self.color.reset}) {self.color.light_green}{self.ok}{self.color.reset}-{self.color.light_red}{self.cp}{self.color.reset}{self.color.reset}",end="\r")
      #sys.stdout.flush()
...
| $$  | $$   \  $/   | $$  | $$| $$  | $$
|__/  |__/    \_/    |__/  |__/|__/  |__/                                                                                                                      
 © {self.color.light_cyan}Avah
 github > {self.color.light_green}None{self.color.light_cyan}
